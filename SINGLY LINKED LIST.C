...
case 1: printf("Enter data"); scanf("%d",&no); push(no);
break; case 2: pop();
...
break; case 4: empty(); break; case 5: exit(0); case 6: display(); break; case 7:
stackcount(); break;
case 8: destroy(); break; default:
 


printf("\n Wrong choice,please select a valid choice"); break;
}
